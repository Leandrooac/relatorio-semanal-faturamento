...
Sistema de planilhas para acompanhamento semanal da carteira de faturamento em regime de Entreposto Aduaneiro, com painel executivo para diretoria e um gerador de apresentações comerciais por cliente. A lógica de negócio e a estrutura do sistema foram especificadas por mim; a automação em Python foi implementada com apoio de ferramentas de IA generativa, enquanto aprofundo meus estudos na linguagem.
